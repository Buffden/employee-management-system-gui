...
export const defaultTableConfig: TableConfig = {
    ...
    columns: [
        { key: 'Col1', header: 'col1', sortable: true, type: ColumnType.STRING },
        { key: 'Col2', header: 'col2', sortable: true, type: ColumnType.STRING },
        { key: 'Col3', header: 'col3', sortable: false, type: ColumnType.STRING },
